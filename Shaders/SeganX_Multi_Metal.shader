        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                float4 frag(v2f i) : SV_Target
                {
                    ...
                    if (matId == 1)
                    {
                        res = tex2D(_VinylTex, i.uv1) * _VinylColor;
                        if (res.a < 1)
                    ...
                    else if (matId == 3)
                    {
                        ...
                        {
                            cube = UNITY_SAMPLE_TEXCUBE(unity_SpecCube0, reflect(-viewDir, i.norm)).rgb;
                    ...
                    if (matId == 1)
                    {
                        ...
                        if (_MetalPower1 > 0.01f)
                        {
                            ...
                            res.rgb += max(spec, cube * 0.3f) * metal * _MetalPower1;
                        }
                    }
                    else if (matId == 3)
                    {
