...
namespace SeganX
{
    ...
    public class BezierLine : MonoBehaviour
    {
        ...
        public static Vector3 GetBezierPoint(Vector3 startPoint, Vector3 startDirection, Vector3 endPoint, Vector3 endDirection, float t)
        {
            return CalculateBezierPoint(t, startPoint, startPoint + startDirection, endPoint + endDirection, endPoint);
        }
