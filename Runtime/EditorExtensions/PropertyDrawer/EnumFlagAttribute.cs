...
namespace SeganX
{
    ...
    public class EnumFlagsAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            int enumLength = property.enumNames.Length - 1;
            ...
            for (int i = 0; i < enumLength; i++)
            {
                ...
                float buttonWidth = ComputeButtonWidth(property.enumDisplayNames[i + 1]);
                ...
                buttonPressed[i] = GUI.Toggle(buttonPos, buttonPressed[i], property.enumDisplayNames[i + 1], EditorStyles.miniButton);
                if (buttonPressed[i])
                    buttonsIntValue |= 1 << i;
