Shader "SeganX/Unlit/Transparent" 
{
	Properties 
	{
		...
		[Header(_______________ Blending Options ______________________________________________)]
	...
	SubShader 
	{
		...
		Pass
		{
			...
			vertex_output vert(vertex_input v)
			{
				...
				o.color = v.color * _ColorStrength;
#else
				o.color = _ColorStrength;
#endif
			...
			fixed4 frag(vertex_output v) : SV_Target
			{
				...
				c *= t0;
#endif // _ADDITIONALTILE_ADD || _ADDITIONALTILE_MULTIPLY
