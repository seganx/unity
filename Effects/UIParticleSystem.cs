    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        protected bool Initialize()
        {
            ...
            if (_particleSystem == null)
            {
                ...
                mainModul.scalingMode = ParticleSystemScalingMode.Local;
            ...
            {
                var mainModul = _particleSystem.main;
                _particles = new ParticleSystem.Particle[mainModul.maxParticles];
            }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                Vector2 position = (mainModul.simulationSpace == ParticleSystemSimulationSpace.Local ? particle.position : _transform.InverseTransformPoint(particle.position));
